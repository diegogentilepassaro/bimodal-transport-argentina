...
contraction alone (interquartile range nine to two log points), and a
...
population; only-road estimates are 0.026 (0.067) and 0.098 (0.133).
...
only-rail OLS coefficient is $-0.004$ (0.019), while IV moves it to
