...
segment carries two pieces of information. The first is its operating
...
it stood in 1960 and as it stood in 1986. The second is its Larkin
Plan status: whether the segment was among the 237 segments that the
1962 Larkin Plan evaluated --- and recommended for closure or
downgrade on the basis of freight-density and operating-cost
criteria --- or among the 328 segments the Plan did not evaluate.
This distinction is the basis of the first instrument
...
Section~\ref{sec:discussion} reports how the estimated effects
vary over the full sweep $\theta \in [1, 12]$.
