...
changes the network total by less than 0.05~percent.} This is a single
...
closed during the military dictatorship (1976--1983). The status is
categorical and undated, so it supports two clean cross sections --- the
network active in 1986, and the network before the dictatorship closures
--- and a third, 1960, under the assumption that the segments closed
...
\railKmPreSeventySix{}~km (\railSharePreSeventySix{}\%) before 1976.
