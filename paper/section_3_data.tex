...
mean 1960 district population is 52{,}965 with a national total of
16.5~million. Population in 1991 comes from the IPUMS microdata
...
$0.54$. Capital Federal and the two Tierra~del~Fuego districts are
...
243 of the 312 districts. A log population change
...
\texttt{.kiro/tasks.md} pending-decision item.]
...
$\Delta\log\mathrm{MA}_i$ has mean $+1.51$, standard deviation $2.45$,
minimum $-7.59$ and maximum $+9.53$; 91\% of districts see a positive
...
has mean $-0.39$ (rail contraction is a small market-access loss) and
$\Delta\log\mathrm{MA}^{\text{only-road}}$ has mean $+1.69$ (road
expansion is a large gain). The sum of the two isolated components
($+1.30$) is slightly below the total
$\Delta\log\mathrm{MA} = +1.51$, reflecting a positive complementarity
