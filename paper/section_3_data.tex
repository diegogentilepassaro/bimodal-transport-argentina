...
plus several Patagonian rivers, together with the Magellan crossing.
...
a midpoint choice within the modern range of estimates rather than a
value taken from any single study --- the
\citet{simonovskawaugh2014} benchmark of approximately 4.1 and the
\citet{donaldson2018} estimate sit nearby --- and
...
% old draft (which had no MA-theta framework at all).
% RESOLVED 2026-07-24 (Cote email): he does not recall a source, so
% 4.55 is now declared a midpoint choice within the modern range with
% SW ~4.1 cited as the nearby benchmark (his suggested option; text
% above updated accordingly). Memo Decision A (theta-tau object)
% remains open and is flagged separately in the placeholder.
