...
Automóvil~Club~Argentino maps for 1954, 1970, and 1986
\citep{acamaps}. The resulting
...
\begin{itemize}\setlength\itemsep{0pt}
  ...
  \item \texttt{lcp}: all bilateral least-cost paths between city
    pairs, routed on a construction-cost raster following
    \citet{faber2014} that
...
time-invariant \texttt{geolev2} geography for Argentina
\citep{ipums2020}, covering 312
...
district-level establishment counts, salaries, and
...
\citep{censo1960agro, indec1988agro} provide \texttt{nexp} (farm operations)
