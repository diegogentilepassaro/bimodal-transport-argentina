...
checks bound, but do not eliminate, the exposure concern; the fully
design-based correction --- recentering each instrument by its
expectation over counterfactual realizations of the Larkin
designations --- is left for future work.
