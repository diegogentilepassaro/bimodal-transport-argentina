...
The sample is 237 districts --- the subset for which the 1947 census
...
The OLS coefficient is 0.039 (0.017), significant at the five-percent
level. The IV-LP estimate is 0.074 (0.050), the IV-Hypo estimate is
0.192 (0.241), and the combined IV estimate is 0.087 (0.041),
significant at the five-percent level. The first-stage $F$ for the
IV-Hypo column on this sample of 237 districts is 1.72, below
...
$F$ for IV-LP is 19.83 and for IV-Both is 11.84.
...
subsample ($N=237$) that is non-random with respect to the full
estimation sample ($N=311$), and the correlations documented in
...
regression refit on the same 237-district subsample. On that
subsample, the IV-Both coefficient on $\Delta \ln
\mathrm{MA}^{\mathrm{full}}_i$ is 0.077 (0.036), with $p=0.032$. This
...
reform pattern on the 237 subset is of the same order as the
