...
For the Larkin instrument, the fully design-based correction ---
recentering the instrument by its expectation over counterfactual
realizations of the study designations --- is left for future work;
no analogous correction exists for the hypothetical-road instrument,
which is a deterministic function of geography.
