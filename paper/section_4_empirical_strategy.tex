...
interact with that subsample selection. Distinguishing these
readings requires analysis of whether the placebo coefficient shrinks
toward zero when the main specification is restricted to the same
235-district sample. This exercise is reported in
Section~\ref{sec:results_robustness}.

% [PLACEHOLDER: Once Section 5.5 robustness is run with the placebo-
%  sample restriction applied to Table 9, update this subsection to
%  report whether the placebo coefficient shrinks.]
