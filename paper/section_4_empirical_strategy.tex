...
report's own accounting. In the digitized tables the
studied share is \railStudiedShare{}~percent of the 1960 network of
Section~\ref{ssec:implementation}, and the new-study segments account
for \railKmNewStudy{}~km; excluding them the share is
\railStudiedShareExNewStudy{}~percent. Our instrument retains these
