...
the national road network (27{,}276~km paved plus 7{,}153~km gravel
in 1986, excluding dirt roads). The digitized road maps used in the
empirical analysis (Section~\ref{sec:data}) cover the broader
network, including provincial roads, and therefore report larger
totals.} Importantly, the spatial pattern
