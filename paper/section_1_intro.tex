...
package falls short: the pre-trends placebo is not a clean null, and
we state that limitation rather than obscure it.
...
(\mainPopSEIVBoth{}) in the combined-IV specification; individually,
the urban, rural, and total-population coefficients are not
statistically distinguishable from zero at the five-percent level. In
