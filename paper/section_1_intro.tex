...
to 28{,}000 kilometers between the mid-1950s and the late 1980s. This
episode offers
...
networks. Our main analysis estimates how regional outcomes—population and
sectoral economic activity—respond to changes in
...
with pre-period balance checks, a pre-trends placebo, and spatial
standard-error sensitivity, and we report where the validation
...
with first-stage $F$ statistics near or above 100. We find no support
...
reported in Section~\ref{sec:results_robustness}.
