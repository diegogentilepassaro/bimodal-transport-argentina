...
the five-percent level, a rejection that spatially robust standard
errors sharpen rather than soften, and we state that limitation
...
rural coefficients are similar in magnitude but less precise. The
