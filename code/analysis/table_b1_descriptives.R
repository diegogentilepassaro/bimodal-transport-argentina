# ===========================================================================
# table_b1_descriptives.R
#
# PURPOSE: Appendix Table B1 — descriptive statistics for the estimation
...
#          descriptives in their Appendix Table A1).
#
...
#
# PRODUCES:
#   results/tables/table_b1_descriptives.{tex,csv}
# ===========================================================================
...
main <- function() {
    ...
    vars <- list(
        ...
        c("Treatment and instruments",
          main_treatment,  "$\\Delta \\ln \\mathrm{MA}^{\\mathrm{full}}$"),
        c("", main_lp_instrument,"$\\Delta \\ln \\mathrm{MA}$, Larkin instrument"),
    ...
    tex_lines <- c(
        ...
        "% Generated by code/analysis/table_b1_descriptives.R.",
        "",
        "\\begin{table}[htbp]",
        "\\centering",
    ...
    out_tex <- file.path(dir_tables, "table_b1_descriptives.tex")
    writeLines(tex_lines, out_tex)
    message("Saved: ", out_tex)

    out_csv <- file.path(dir_tables, "table_b1_descriptives.csv")
